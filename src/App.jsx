...
function App() {
  return (
    <div className="app">
        ...
        <div className="hero-inner">
          ...
          <div className="hero-content">
            ...
            <div className="hero-card" aria-hidden>
              {/* small preview stack using your images */}
      ...
      {/* rest of page (unchanged from previous version) */}
      <main>
        <section id="info" className="info-section">
          <div className="info-card">
            <div><strong>Trade Name:</strong> The Pearl</div>
            <div><strong>Legal Name:</strong> Auro Realty India Pvt. Ltd.</div>
          </div>
        </section>
      ...
      <footer className="footer-section">
        <p>📞 +91 1234567890</p>
        <p>📍 123, Aurobindo Marg, New Delhi - 110016</p>
        <p>GST Number: ABCDE12345FG678</p>
      </footer>
    </div>
  );
}
